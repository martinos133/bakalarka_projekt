...
export class UsersController {
  ...
  @Post('me/subscription/demo-checkout')
  @ApiOperation({ summary: 'Demo aktivácia prémiového balíka po checkoute (bez reálnej platby)' })
  demoCheckout(@Request() req, @Body() body: { plan: string }) {
